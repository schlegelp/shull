...
def FormTriangles(pts, seedTriangle, orderToAddPts):
    #print(pts)
    print("Initial triangle", seedTriangle)
    #print(orderToAddPts)
...
def CheckAndFlipTrianglePair(pts, triOrdered1, triOrdered2, angleCache, distCache, debugMode = 0):
    ...
    print(t1, t3, flipDegenerateTri, flipForDelaunay)
...
def FlipTriangles(pts, triangles, nodeOrdering = None):
    ...
    while running:
        ...
        for edgeKey in sharedEdgeKeys:
            ...
            print("tri1: {}, tri2: {}, flip_needed: {}, ft1: {}, ft2: {}".format(triOrdered1, triOrdered2, flipNeeded, ft1, ft2))
...
def PySHull(pts):
    ...
    print(f"Formed {len(triangles)} initial triangles:", triangles)
